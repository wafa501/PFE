...
class FacebookSavePagesPosts extends Command
{
    protected $signature = 'app:facebook-save-pages-posts {pageId}';
    ...
    public function handle()
    {
        ...
        $controller = new FacebookPagePostController();

        $controller->fetchPagesPosts($pageId,$pageAccessToken);
