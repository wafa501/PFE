...
class FacebookSaveMyStats extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:facebook-save-my-stats {pageId}';
    ...
    public function handle()
    {
        ...
        $controller = new FacebookPageStatisticsController();

        $controller->fetchAllStats($pageId, $pageAccessToken);
